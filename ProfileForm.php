...
<body>
    ...
    <div class="container-md" style="background-color:#fff;">
                            ...
                            <div class="boxform">
                                <div class="input-box-group2">
                                    <div class="input-box">
                                        ...
                                        <input class="input-text-pass" type="password" id="password" name="password" size="25" 
                                        placeholder="*****" value=""><br><br>
                                    </div>
                                    <div class="myPass">
                                        <label>New password:</label><br>
                                        <input class="input-text-pass" type="password" id="npassword" name="npassword" size="25" value=""><br><br>
                                    </div>
                                    <div class="myPass">
                                        <label>Confirm new password:</label><br>
                                        <input class="input-text-pass" type="password" id="cpassword" name="cpassword" size="25" value=""><br><br>
                                    </div>
                                </div>
                            </div>
                        </div>
